...
MAIN_MENU_TEXT = (
    ...
    "💰 Экономия до 68% — платишь от 4 990₽ вместо 15 800₽\n"
...
SECTION_TEXTS = {
    "chatgpt": (
        ...
        "<blockquote>Из России официально не оплатить — нужна иностранная карта и адрес за рубежом. "
        "У нас всё проще: выбрал → оплатил → получил свой персональный аккаунт.</blockquote>\n\n"
        ...
        "🎁 VPN в подарок — входит в ChatGPT Pro\n\n"
        "👇 <b>Выбери подписку:</b>"
    ),
    "gemini": (
        "💎 <b>Google Gemini Ultra — вся мощь AI от Google</b>\n\n"
        "<blockquote>Gemini Ultra — это максимальная подписка Google AI: генерация видео, картинок, исследования, "
        "AI-агенты и 30 ТБ облака. Официально стоит $249.99/мес и недоступна в России напрямую.</blockquote>\n\n"
